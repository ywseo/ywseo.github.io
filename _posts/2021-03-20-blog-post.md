...
"Ideas are a-dime-a-dozen. An execution is what makes the winner apart from the rest," "Dreams are a dime a dozen, it's their execution that counts." [Theodore Roosevelt](https://en.wikipedia.org/wiki/Theodore_Roosevelt).

"I think if you do something and it turns out pretty good, then you should go do something else wonderful, not dwell on it for too long. Just figure out what's next," [Steve Jobs](https://en.wikipedia.org/wiki/Steve_Jobs).
